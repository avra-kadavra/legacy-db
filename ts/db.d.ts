...
export interface companiesAttribute {
  ...
  send_bulk_reminder_notification:number;
  series_regex?:string;
  payment_concept_id?:number;
  receivables_extra_fields?:string;
}
...
// table: licence_partner
export interface licence_partnerAttribute {
  id:number;
  licence_id:number;
  partner_id:number;
  created_at:Date;
...
export interface licence_partnerInstance extends Sequelize.Instance<licence_partnerAttribute>, licence_partnerAttribute { }
export interface licence_partnerModel extends Sequelize.Model<licence_partnerInstance, licence_partnerAttribute> { }
...
// table: licence_upgrade
export interface licence_upgradeAttribute {
  id:number;
  licence_id:number;
  upgrade_id:number;
  count?:number;
...
export interface licence_upgradeInstance extends Sequelize.Instance<licence_upgradeAttribute>, licence_upgradeAttribute { }
export interface licence_upgradeModel extends Sequelize.Model<licence_upgradeInstance, licence_upgradeAttribute> { }
...
// table: partner_banners
export interface partner_bannersAttribute {
  id:number;
  partner_id:number;
  banner_id:number;
  created_at:Date;
...
export interface partner_bannersInstance extends Sequelize.Instance<partner_bannersAttribute>, partner_bannersAttribute { }
export interface partner_bannersModel extends Sequelize.Model<partner_bannersInstance, partner_bannersAttribute> { }

// table: partners
export interface partnersAttribute {
  id:number;
  name:string;
  code:string;
  created_at:Date;
...
export interface partnersInstance extends Sequelize.Instance<partnersAttribute>, partnersAttribute { }
export interface partnersModel extends Sequelize.Model<partnersInstance, partnersAttribute> { }
...
// table: reference_receivable
export interface reference_receivableAttribute {
  id:number;
  receivable_id:number;
  reference_id:number;
  created_at:Date;
...
export interface reference_receivableInstance extends Sequelize.Instance<reference_receivableAttribute>, reference_receivableAttribute { }
export interface reference_receivableModel extends Sequelize.Model<reference_receivableInstance, reference_receivableAttribute> { }
...
// table: upgrades
export interface upgradesAttribute {
  id:number;
  description?:string;
  created_at:Date;
  updated_at:Date;
...
export interface upgradesInstance extends Sequelize.Instance<upgradesAttribute>, upgradesAttribute { }
export interface upgradesModel extends Sequelize.Model<upgradesInstance, upgradesAttribute> { }
